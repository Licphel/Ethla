...
public class WallRendererRepeat : WallRendererSingle
{

    //Only support 16 * n x 16 * n texture.
	protected override void drawInternal(Graphics graphics, Wall wall, Direction overlapping, float x, float y, float w, float h)
	{
	...
	protected override void drawItemSymbolInternal(Graphics graphics, Wall wall, float x, float y, float w = 1, float h = 1)
	{
		Icon icon = WallModels.GetIcon(wall);
